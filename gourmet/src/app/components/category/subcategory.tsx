...
const Subcategory = (prop: propType) => {
    return (
        <div>
            <Navbar />
            <div className="flex ">
                <div className="w-[230px] h-[75vh] m-[30px]  shadow border  border-gray-200 rounded-2xl flex flex-col space-y-6 text-2xl  ">
                    {/*for the side bar section */}

                    <div className="flex flex-row  items-center  mt-2  group/item hover:bg-purple-200 hover:rounded-lg hover:pb-2  pb-2 ">
                        <div className=" absolute-full items-center  ml-4 relative">
                            <img className="absolute" src="https://www.itcstore.in/_next/image?url=https%3A%2F%2Fadmin.itcstore.in%2Fmedia%2Fcatalog%2Fcategory%2Fatta_icon_1_new.png&w=96&q=75" />
                            <img className="rounded-full mt-4 " src='https://t4.ftcdn.net/jpg/05/97/49/09/360_F_597490918_dugDbSuqx6YSRmCaYiZJ6pCr37cXK3Rv.jpg' /> 
                        </div>
                        <div className=" text-3xl  m-4">Staples</div>
                    </div>

                    <div className="flex flex-row  items-center    group/item hover:bg-slate-100  pb-1 ">
                        <div className=" rounded-full items-center  ml-4">
      ...
      <div className="flex items-center">
        ...
        <div className="ml-auto"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-bag-plus" viewBox="0 0 16 16">
            ...
            <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z" />
                    ...
                    </div> {/*for the product page section */}
            </div>
        </div>
    );
};
