...
const products = [
  {
    id: 1,
    title: "Dairy Milk",
    url: "https://images.unsplash.com/photo-1646753522408-077ef9839300?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8NjZ8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
    brand: "cadbury",
  },
  {
    id: 2,
    title: "Kitkat",
    url: "https://images.unsplash.com/photo-1651950537598-373e4358d320?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwcm9maWxlLXBhZ2V8MjV8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60",
    brand: "cadbury",
  },
  {
    id: 3,
...
const Products:React.FC<SubcategoryProps> = ({params})=>{
  const {slug,subslug} = params;
  const category:string = slug;
  const subcategory:string = subslug;
...
<Link href={`/category/${category}/${subcategory}/${product.title.toLowerCase()}`}>
